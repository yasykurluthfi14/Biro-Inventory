	 ...
	 <div id="layoutSidenav_content">
                  ...
                  <div class="col-lg-12 main-chart">
						...
						<div class="card mb-4">
							...
							<form action="fungsi/edit/edit_admin.php?inventory_admin=edit" method="POST" enctype="multipart/form-data">
						...
						<a href="admin.php?page=inventory_admin"><button class="btn btn-primary"><i class="fa fa-angle-left"></i> Balik </button></a>
							</div>
