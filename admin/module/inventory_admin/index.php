	  ...
	  <div id="layoutSidenav_content">		
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
							...
							<a href="admin.php?page=inventory_admin/tambah"><button class="btn btn-primary btn-md pull-right"><i class="fa fa-plus"></i> Insert Data</button></a>
                            </div>
								...
								?>
									...
									<tr>
										...
										<td>
											...
											<a href="admin.php?page=inventory_admin/edit&inventory_admin=<?php echo $isi['id'];?>"><button class="btn btn-warning btn-xs">Edit</button></a>
											<a href="fungsi/hapus/hapus_admin.php?inventory_admin=hapus&id=<?php echo $isi['id'];?>" onclick="javascript:return confirm('Hapus Data ?');"><button class="btn btn-danger btn-xs">Hapus</button></a>
										</td> 
									</tr>
