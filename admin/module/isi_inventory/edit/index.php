 <!--sidebar end-->
      ...
      *********************************************************************************************************************************************************** -->
      <!--main content start-->
      <?php 
	$id = $_GET['isi_inventory'];
	$hasil = $lihat -> inventoryadmin_id_edit($id);
?>
	 ...
	 <div id="layoutSidenav_content">
                  ...
                  <div class="col-lg-12 main-chart">
						...
						<div class="card mb-4">
							...
							<form action="fungsi/edit/edit_admin.php?isi_inventory=edit" method="POST" enctype="multipart/form-data">
						...
						<a href="admin.php?page=isi_inventory&id=<?php echo $hasil['no_room'];?>"><button class="btn btn-primary"><i class="fa fa-angle-left"></i> Balik </button></a>
							</div>
