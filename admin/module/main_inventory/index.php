      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="layoutSidenav_content">		
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Tabel Main Inventaris</h1>
                       
                        <div class="card mb-4">
				
                            <div class="card-header">
							<a href="admin.php?page=main_inventory/tambah"><button class="btn btn-primary btn-md pull-right"><i class="fa fa-plus"></i> Insert Data</button></a>
                            </div>
								...
								?>
									...
									<tr>
										...
										<td style="width: 25% ;">
											...
											<a href="admin.php?page=main_inventory/edit&main_inventory=<?php echo $isi['id'];?>"><button class="btn btn-warning btn-xs">Edit</button></a>
											<a href="admin.php?page=main_inventory/pindah&main_inventory=<?php echo $isi['id'];?>"><button class="btn btn-success btn-xs">Pindah</button></a>
										</td> 
									</tr>
